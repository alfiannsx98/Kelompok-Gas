...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2021 at 05:47 AM
...
(29, 22, 'Sistem Cerdas', 'siscer', 1),
(30, 23, 'Sistem Cerdas', 'siscer', 1),
(31, 24, 'Tabel Keputusan', 'rule', 1),
(33, 25, 'Tabel Keputusan', 'rule', 1),
(34, 22, 'Tabel Keputusan', 'siscer/rule', 1),
(35, 22, 'Assignment Obat', 'siscer/assign_obat', 1);
...
CREATE TABLE `tb_keputusan` (
  `id` int(11) NOT NULL,
  `kode_opt` varchar(6) NOT NULL,
  `GJ01` varchar(6) NOT NULL,
  `GJ02` varchar(6) NOT NULL,
  `GJ03` varchar(6) NOT NULL,
  `GJ04` varchar(6) NOT NULL,
  `GJ05` varchar(6) NOT NULL,
  `GJ06` varchar(6) NOT NULL,
  `GJ07` varchar(6) NOT NULL,
  `GJ08` varchar(6) NOT NULL,
  `GJ09` varchar(6) NOT NULL,
  `GJ10` varchar(6) NOT NULL,
  `GJ11` varchar(6) NOT NULL,
  `GJ12` varchar(6) NOT NULL,
  `GJ13` varchar(6) NOT NULL,
  `GJ14` varchar(6) NOT NULL,
  `GJ15` varchar(6) NOT NULL,
  `GJ16` varchar(6) NOT NULL,
  `GJ17` varchar(6) NOT NULL,
  `GJ18` varchar(6) NOT NULL,
  `GJ19` varchar(6) NOT NULL,
  `GJ20` varchar(6) NOT NULL,
  `GJ21` varchar(6) NOT NULL,
  `GJ22` varchar(6) NOT NULL,
  `GJ23` varchar(6) NOT NULL,
  `GJ24` varchar(6) NOT NULL,
  `GJ25` varchar(6) NOT NULL,
  `GJ26` varchar(6) NOT NULL,
  `GJ27` varchar(6) NOT NULL,
  `GJ28` varchar(6) NOT NULL,
  `GJ29` varchar(6) NOT NULL,
  `GJ30` varchar(6) NOT NULL,
  `GJ31` varchar(6) NOT NULL,
  `GJ32` varchar(6) NOT NULL,
  `GJ33` varchar(6) NOT NULL,
  `GJ34` varchar(6) NOT NULL,
  `GJ35` varchar(6) NOT NULL,
  `GJ36` varchar(6) NOT NULL,
  `GJ37` varchar(6) NOT NULL,
  `GJ38` varchar(6) NOT NULL,
  `GJ39` varchar(6) NOT NULL,
  `GJ40` varchar(6) NOT NULL,
  `GJ41` varchar(6) NOT NULL,
  `GJ42` varchar(6) NOT NULL,
  `GJ43` varchar(6) NOT NULL,
  `GJ44` varchar(6) NOT NULL,
  `GJ45` varchar(6) NOT NULL,
  `GJ46` varchar(6) NOT NULL,
  `GJ47` varchar(6) NOT NULL,
  `GJ48` varchar(6) NOT NULL,
  `GJ49` varchar(6) NOT NULL,
  `GJ50` varchar(6) NOT NULL,
  `GJ51` varchar(6) NOT NULL,
  `GJ52` varchar(6) NOT NULL,
  `GJ53` varchar(6) NOT NULL,
  `GJ54` varchar(6) NOT NULL,
  `GJ55` varchar(6) NOT NULL,
  `GJ56` varchar(6) NOT NULL,
  `GJ57` varchar(6) NOT NULL,
  `GJ58` varchar(6) NOT NULL,
  `GJ59` varchar(6) NOT NULL,
  `GJ60` varchar(6) NOT NULL,
  `GJ61` varchar(6) NOT NULL,
  `GJ62` varchar(6) NOT NULL,
  `GJ63` varchar(6) NOT NULL,
  `GJ64` varchar(6) NOT NULL,
  `GJ65` varchar(6) NOT NULL,
  `GJ66` varchar(6) NOT NULL,
  `GJ67` varchar(6) NOT NULL,
  `GJ68` varchar(6) NOT NULL,
  `GJ69` varchar(6) NOT NULL,
  `GJ70` varchar(6) NOT NULL,
  `GJ71` varchar(6) NOT NULL,
  `GJ72` varchar(6) NOT NULL,
  `GJ73` varchar(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tb_keputusan` (`id`, `kode_opt`, `GJ01`, `GJ02`, `GJ03`, `GJ04`, `GJ05`, `GJ06`, `GJ07`, `GJ08`, `GJ09`, `GJ10`, `GJ11`, `GJ12`, `GJ13`, `GJ14`, `GJ15`, `GJ16`, `GJ17`, `GJ18`, `GJ19`, `GJ20`, `GJ21`, `GJ22`, `GJ23`, `GJ24`, `GJ25`, `GJ26`, `GJ27`, `GJ28`, `GJ29`, `GJ30`, `GJ31`, `GJ32`, `GJ33`, `GJ34`, `GJ35`, `GJ36`, `GJ37`, `GJ38`, `GJ39`, `GJ40`, `GJ41`, `GJ42`, `GJ43`, `GJ44`, `GJ45`, `GJ46`, `GJ47`, `GJ48`, `GJ49`, `GJ50`, `GJ51`, `GJ52`, `GJ53`, `GJ54`, `GJ55`, `GJ56`, `GJ57`, `GJ58`, `GJ59`, `GJ60`, `GJ61`, `GJ62`, `GJ63`, `GJ64`, `GJ65`, `GJ66`, `GJ67`, `GJ68`, `GJ69`, `GJ70`, `GJ71`, `GJ72`, `GJ73`) VALUES
(1, 'HM01', '1', '1', '1', '1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(2, 'HM02', '', '', '', '', '1', '1', '1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(3, 'HM03', '', '', '', '', '', '', '', '1', '1', '1', '1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(4, 'HM04', '', '', '', '1', '', '', '', '', '', '', '', '1', '1', '1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
--
-- Table structure for table `tb_relasi_obt`
--

CREATE TABLE `tb_relasi_obt` (
  `kode_opt` varchar(6) NOT NULL,
  `kode_obat` varchar(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tb_relasi_obt`
--

INSERT INTO `tb_relasi_obt` (`kode_opt`, `kode_obat`) VALUES
('HM01', 'OB001'),
('HM01', 'OB002'),
('HM01', 'OB003'),
('HM01', 'OB004');
...
ALTER TABLE `tb_keputusan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `index_kode_opt` (`kode_opt`);
...
--
-- Indexes for table `tb_opt`
--
ALTER TABLE `tb_opt`
  ADD PRIMARY KEY (`kode_opt`);

--
-- Indexes for table `tb_relasi_obt`
--
ALTER TABLE `tb_relasi_obt`
  ADD KEY `index_opt` (`kode_opt`),
  ADD KEY `index_obat` (`kode_obat`);
...
--
ALTER TABLE `access_user`
  MODIFY `id_access_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
